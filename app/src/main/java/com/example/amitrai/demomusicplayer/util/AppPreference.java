...
//        login.setUserType(mPref.getString(KEY_USER_TYPE, ""));
//        login.setAvatarUrl(mPref.getString(KEY_USER_AVTAR, ""));
//        login.setFullName(mPref.getString(KEY_USER_NAME, ""));
//        login.setUserID(mPref.getString(KEY_USERID, ""));
//        login.setEmailId(mPref.getString(KEY_USER_EMAIL, ""));
//        login.setMobile(mPref.getString(KEY_USER_MOBILE, ""));
//        login.setUserAlready(mPref.getString(KEY_USERALREADY, "0"));
//        login.setReferralCode(mPref.getString(KEY_REFERRAL_CODE,""));
//        login.setReferralUrl(mPref.getString(KEY_REFERRAL_URL,""));
